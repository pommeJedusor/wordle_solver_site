  ...
  return (
    <div is-game="true" className="flex flex-col items-center gap-10 dark:bg-background-night bg-background-day min-h-dvh">
      ...
      <section className="w-full flex flex-col items-center">
        <h2 className="w-1/3 text-xl font-[600]">Two lists of words</h2>
      ...
      <section className="w-full flex flex-col items-center">
        <h2 className="w-1/3 text-xl font-[600]">Wordle Solver, the way it works</h2>
        <p className="w-1/3 text-lg mb-2">
      ...
      <section className="w-full flex flex-col items-center">
        <h2 className="w-1/3 text-xl font-[600]">Optimisations</h2>
        <h3 className="w-1/3 text-xl font-[500] my-2">Color patterns caching</h3>
        <p className="w-1/3 text-lg mb-2">
        ...
        <h3 className="w-1/3 text-xl font-[500] my-2">Cython</h3>
        <p className="w-1/3 text-lg mb-2">
      ...
      <section className="w-full flex flex-col items-center">
        <h2 className="w-1/3 text-xl font-[600]">Site</h2>
        <p className="w-1/3 text-lg mb-2">
          for the <a
            className="underline text-valid-letter-day hover:text-well-placed-letter-day visited:text-unvalid-letter-day dark:text-valid-letter-night dark:hover:text-well-placed-letter-night dark:visited:text-unvalid-letter-night"
